        ...
        <div id='news'>
            <div className='newsContainer'>
                <div className='newsImage'>
                    <img src='https://upload.wikimedia.org/wikipedia/en/thumb/5/56/AIT_Sydney%2C_Logo%2C_Horizontal.png/220px-AIT_Sydney%2C_Logo%2C_Horizontal.png'/>
                </div>
            ...
            <div className='newsContainer'>
                <div className='newsImage'>
                <img src='https://lh3.googleusercontent.com/FJULnXYxJ_Vbg0ITDswhiFLrAuuqLrGtEPbZgCGcUiIr3SAvB4rnpO8FGdXBNDP6mw'/>
                </div>
                <div className='newsDescription'>
            ...
            <div className='newsContainer'>
                <div className='newsImage'>
                <img src='https://eildonlakemotel.netlify.app/static/media/bannerLogo.02a11922.png'/>
                </div>
                <div className='newsDescription'>
